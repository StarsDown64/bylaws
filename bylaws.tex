...
\subsection{}
This chapter shall be located at Purdue University, West Lafayette, IN and Indianapolis, IN.
\subsection{}
...
\begin{itemize}
    ...
    \item Have not missed two unexcused consecutive meetings at their respective location
    \item Serve at least one weekly POD shift during the semester if located in West Lafayette
    \item Complete an additional weekly POD shift if located in West Lafayette or, with prior approval from the Executive Committee, fulfill a weekly hour of ECE-related or community service. Members of the Executive Committee are exempt from this requirement.
...
\subsection{ }
Candidates located in West Lafayette shall complete the following requirements:
\begin{itemize}
...
\end{itemize}
\subsection{ }
Candidates located in Indianapolis shall complete the following requirements:
\begin{itemize}
    \item \textbf{Faculty Endorsements}: Obtain the signatures of at least four (4) faculty members of the Purdue University Electrical and Computer Engineering Department signifying their endorsement of the candidate.
    \item \textbf{Active Member Endorsements}: Obtain the signatures of at least two (2) active members of the Chapter, though this number may be changed by a vote at the start of any semester.
    \item \textbf{Advisor Meetings}: Schedule and attend a meeting with the Head Faculty Advisor(s) of the Chapter to discuss the responsibilities and expectations of membership.
    \item \textbf{Department Head Meeting}: Schedule and attend a meeting with the Head of the Purdue University Electrical and Computer Engineering Department (or their designated representative).
    \item \textbf{Executive Board Endorsements}: Obtain the signature of each current member of the Chapter's Executive Board, indicating their approval of the candidate.
    \item \textbf{Induction Fees}: Pay both the national Eta Kappa Nu (IEEE-HKN) induction fee and the local chapter induction fee as determined by the Executive Board.
...
The Officers of the Chapter shall be the President, PWL Vice President, PIN Vice President, Treasurer, Recording Secretary, Public Relations Director, PWL Events Director, PIN Events Director, Facilities Director, Operations Director, Recruitment Director, Volunteer Director, PIN Outreach Director, Lab Director, and President-Elect. [Other officer positions may be added by the Chapter.] The positions of Corresponding Secretary and News Correspondent shall be merged into the single office of Public Relations Director. Officer duties are detailed in the IEEE-Eta Kappa Nu Operations Manual and in the present article.
...
\begin{itemize}
    ...
    \item \textbf{President and Vice President:} Nominees for the offices of President, PWL Vice President, or PIN Vice President must have previously served a full term in at least one (1) other elected officer position within the Chapter.
\end{itemize}
...
\end{itemize}
\subsubsection{PWL Vice President}
The duties of the PWL Vice President shall be to:
\begin{itemize}
...
\begin{itemize}
	\item Provide overall leadership and strategic direction for the Indianapolis location of the Chapter, ensuring its activities align with its mission.
	\item Serve as the primary representative and spokesperson for the Indianapolis location of the Chapter when interfacing with other organizations, the university, and the public in Indianapolis, fostering positive relationships.
    \item Support the President in their duties and assume the responsibilities of the President in their absence or inability to serve.
    \item Oversee the chairs of any other committees that do not report to another specific officer, ensuring effective communication and collaboration.
    \item Attend the national student leadership conference during their term to represent the Chapter and gather valuable insights, or appoint a representative in their stead if unable to attend.
    \item Assist in the development and implementation of the Chapter's strategic goals and initiatives.
...
\end{itemize}
\subsubsection{PWL Events Director}
The duties of the PWL Events Director shall be to:
\begin{itemize}
...
\begin{itemize}
	...
	\item Work closely with the PIN Outreach Director to develop and implement effective advertising and promotional strategies for all Indianapolis Chapter events, volunteering, and celebrating the Chapter's service contributions.
    ...
    \item Coordinate with the PIN Vice President on any issues related to the physical infrastructure and equipment within the lab space.
    ...
    \item Regularly report on the activities and outcomes of the PIN Events Committee to the Executive Board.
...
\begin{itemize}
	\item Identify, evaluate, and propose potential volunteer opportunities in Indianapolis that align with the Chapter's mission and the interests of its members.
	\item Coordinate and oversee all recruitment events and activities, such as information sessions, outreach programs, and collaborations with other student organizations at PIN.
	\item Work collaboratively with the PIN Events Director to publicize volunteer opportunities and celebrate the Chapter's service contributions at PIN.
	\item Serve as the primary point of contact for prospective members at PIN, providing information and answering inquiries about the Chapter and the induction process.
    \item Perform other duties related to PIN membership recruitment and onboarding as needed.
	\item Perform other duties related to the Chapter's Indianapolis volunteer efforts as needed.
\end{itemize}
...
In the event that the President is unable to complete their term, the Vice President shall assume the role of President for the remainder of the term. The PWL Vice President will then appoint a new PWL Vice President from among the active members, subject to approval by a majority vote of general membership at the next regular meeting. If the PWL Vice President is also unable to serve, the Executive Board will appoint a temporary President from among its members until a special election can be held to fill the position.
...
\subsection{}
A quorum for the transaction of business at an all Executive Committee meeting shall be 50\%. A quorum for the transaction of the Chapter business at a PWL Executive Committee meeting at the West Lafayette location shall consist of at least 50\% of the active West Lafayette Chapter members. A quorum for the transaction at a PIN Executive Committee meeting at the Indianapolis location shall consist of at least 50\% of the active Indianapolis Chapter members. 
...
\subsubsection{PWL Events Committee}
The PWL Events Committee shall operate under the direction of the PWL Events Director and shall be responsible for:
\begin{itemize}
    ...
    \item Assist the PWL Events Director in all logistical aspects of event planning and execution, including venue booking, catering arrangements, and setup.
    \item Brainstorm and propose ideas for new and engaging events for the Chapter.
    \item Support the PWL Events Director in communicating event details and progress to the Executive Board.
    \item Assist the PWL Events Director in other duties related to Chapter events as needed.
\end{itemize}

\subsubsection{PIN Events Committee}
The PIN Events Committee shall operate under the direction of the PWL Events Director and shall be responsible for:
\begin{itemize}
    \item Plan and coordinate a diverse range of social activities, labs, or volunteering for the Chapter membership to foster camaraderie and engagement.
    \item Organize and execute the semesterly picnic or a similar large social gathering for the Chapter.
    \item Develop a semesterly calendar of events that includes a minimum of twelve (12) activities for the Chapter, encompassing social, professional development, and other relevant opportunities.
    \item Assist the PIN Events Director in all logistical aspects of event planning and execution, including venue booking, catering arrangements, and setup.
    \item Brainstorm and propose ideas for new and engaging events for the Chapter.
    \item Support the PIN Events Director in communicating event details and progress to the Executive Board.
    \item Assist the PIN Events Director in other duties related to Chapter events as needed.
\end{itemize}
...
\subsubsection{PWL VP Committee}
The PWL VP Committee shall operate under the direction of the PWL Vice President and shall be responsible for:
\begin{itemize}
    ...
    \item Conducting the end-of-semester audit of the Chapter's financial accounts to ensure accuracy and transparency, and reporting findings to the PWL Vice President and the Executive Board.
    \item Recruiting and engaging Chapter members to actively participate in committee activities and events.
    \item Regularly reporting on the progress and outcomes of committee activities to the PWL Vice President.
    \item Performing other duties as assigned by the PWL Vice President or the Executive Board.
\end{itemize}

\subsubsection{PIN VP Committee}
The PIN VP Committee shall operate under the direction of the PIN Vice President and shall be responsible for:
\begin{itemize}
    \item Recruiting and engaging Chapter members to actively participate in committee activities and events.
    \item Regularly reporting on the progress and outcomes of committee activities to the PIN Vice President.
    \item Performing other duties as assigned by the PIN Vice President or the Executive Board.
\end{itemize}
...
\subsection{}
A quorum for the transaction of all Chapter business shall consist of at least 50\% of the active Chapter members. A quorum for the transaction of the Chapter business at the West Lafayette location shall consist of at least 50\% of the active West Lafayette Chapter members. A quorum for the transaction of the Chapter business at the Indianapolis location shall consist of at least 50\% of the active Indianapolis Chapter members. Student members pursuing a cooperative program or those who are off the campus on an industrial assignment at the time of a meeting shall not be counted in the total membership for the purpose of determining a quorum. In addition, active members with approved, full-semester conflicts with chapter meetings, as acknowledged by the executive committee, are likewise not counted in the total membership for the purpose of determining quorum.
...
\subsection{}
Upon the satisfactory completion of a full term of office, each Chapter officer shall be entitled to receive a lapel pin recognizing their service. Additionally, the President shall receive a gavel or a pen, and the PWL Vice President and the PIN Vice President shall receive a pen as further acknowledgement of their roles.
